...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	{
		public Indicators.gambcl.PaperFeet PaperFeet(bool useFractalEnergy, double alpha, int nFE, int gLength, int betaDev, double overboughtLevel, double oversoldLevel, Brush overboughtRegionBrush, Brush oversoldRegionBrush, int regionOpacity, bool enableLongEntrySignals, bool enableShortEntrySignals, Brush longEntrySignalBrush, Brush shortEntrySignalBrush, int signalsOpacity, bool enableAlerts, string longEntryAlert, string shortEntryAlert)
		{
			return indicator.PaperFeet(Input, useFractalEnergy, alpha, nFE, gLength, betaDev, overboughtLevel, oversoldLevel, overboughtRegionBrush, oversoldRegionBrush, regionOpacity, enableLongEntrySignals, enableShortEntrySignals, longEntrySignalBrush, shortEntrySignalBrush, signalsOpacity, enableAlerts, longEntryAlert, shortEntryAlert);
		}

		public Indicators.gambcl.PaperFeet PaperFeet(ISeries<double> input , bool useFractalEnergy, double alpha, int nFE, int gLength, int betaDev, double overboughtLevel, double oversoldLevel, Brush overboughtRegionBrush, Brush oversoldRegionBrush, int regionOpacity, bool enableLongEntrySignals, bool enableShortEntrySignals, Brush longEntrySignalBrush, Brush shortEntrySignalBrush, int signalsOpacity, bool enableAlerts, string longEntryAlert, string shortEntryAlert)
		{
			return indicator.PaperFeet(input, useFractalEnergy, alpha, nFE, gLength, betaDev, overboughtLevel, oversoldLevel, overboughtRegionBrush, oversoldRegionBrush, regionOpacity, enableLongEntrySignals, enableShortEntrySignals, longEntrySignalBrush, shortEntrySignalBrush, signalsOpacity, enableAlerts, longEntryAlert, shortEntryAlert);
		}
	}
